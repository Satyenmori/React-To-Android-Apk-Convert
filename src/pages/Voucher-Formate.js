...
<TALLYMESSAGE xmlns:UDF="TallyUDF">
  ...
  >
    ...
    <DATE>${sales.date.replace(/-/g, "")}</DATE>
    <VCHSTATUSDATE>${sales.date.replace(/-/g, "")}</VCHSTATUSDATE>
    ...
    <COUNTRYOFRESIDENCE>India</COUNTRYOFRESIDENCE>
    <PLACEOFSUPPLY>Gujarat</PLACEOFSUPPLY>
    <PARTYNAME>${sales.party}</PARTYNAME>
    <GSTREGISTRATION TAXTYPE="GST" TAXREGISTRATION="">
      Gujarat Registration
    </GSTREGISTRATION>
    <VOUCHERTYPENAME>Sales</VOUCHERTYPENAME>
    <PARTYLEDGERNAME>${sales.party}</PARTYLEDGERNAME>
    <VOUCHERNUMBER>30</VOUCHERNUMBER>
    <BASICBUYERNAME>${sales.party}</BASICBUYERNAME>
    <CMPGSTREGISTRATIONTYPE>Regular</CMPGSTREGISTRATIONTYPE>
    <PARTYMAILINGNAME>${sales.party}</PARTYMAILINGNAME>
    <CONSIGNEEMAILINGNAME>${sales.party}</CONSIGNEEMAILINGNAME>
    <CONSIGNEESTATENAME>Gujarat</CONSIGNEESTATENAME>
    <CMPGSTSTATE>Gujarat</CMPGSTSTATE>
    <CONSIGNEECOUNTRYNAME>India</CONSIGNEECOUNTRYNAME>
    <BASICBASEPARTYNAME>${sales.party}</BASICBASEPARTYNAME>
    <NUMBERINGSTYLE>Auto Retain</NUMBERINGSTYLE>
    <CSTFORMISSUETYPE>&#4; Not Applicable</CSTFORMISSUETYPE>
    <CSTFORMRECVTYPE>&#4; Not Applicable</CSTFORMRECVTYPE>
    <FBTPAYMENTTYPE>Default</FBTPAYMENTTYPE>
    ...
    <AUDITENTRIES.LIST> </AUDITENTRIES.LIST>
    <DUTYHEADDETAILS.LIST> </DUTYHEADDETAILS.LIST>
    <GSTADVADJDETAILS.LIST> </GSTADVADJDETAILS.LIST>${str}
    <CONTRITRANS.LIST> </CONTRITRANS.LIST>
    <EWAYBILLERRORLIST.LIST> </EWAYBILLERRORLIST.LIST>
    <IRNERRORLIST.LIST> </IRNERRORLIST.LIST>
    <HARYANAVAT.LIST> </HARYANAVAT.LIST>
    ...
    <LEDGERENTRIES.LIST>
      ...
      <LEDGERNAME>${sales.party}</LEDGERNAME>
      <GSTCLASS>&#4; Not Applicable</GSTCLASS>
      <ISDEEMEDPOSITIVE>Yes</ISDEEMEDPOSITIVE>
      <LEDGERFROMITEM>No</LEDGERFROMITEM>
      <REMOVEZEROENTRIES>No</REMOVEZEROENTRIES>
...
<TALLYMESSAGE xmlns:UDF="TallyUDF">
  <VOUCHER
    REMOTEID="3992d979-db88-4ec3-a4ba-fe3818001634"
    VCHKEY="a282ccd7-4452-4ea6-8468-933b6012dabd-0000b147:000000c8"
    VCHTYPE="Sales"
    ACTION="Create"
    OBJVIEW="Invoice Voucher View"
  >
    ...
    <DATE>20240926</DATE>
    <VCHSTATUSDATE>20240926</VCHSTATUSDATE>
    <GUID>3992d979-db88-4ec3-a4ba-fe3818001634</GUID>
    <GSTREGISTRATIONTYPE>Regular</GSTREGISTRATIONTYPE>
    <VATDEALERTYPE>Regular</VATDEALERTYPE>
    <STATENAME>Gujarat</STATENAME>
    <COUNTRYOFRESIDENCE>India</COUNTRYOFRESIDENCE>
    <PLACEOFSUPPLY>Gujarat</PLACEOFSUPPLY>
    <PARTYNAME>Flonix</PARTYNAME>
    <GSTREGISTRATION TAXTYPE="GST" TAXREGISTRATION="">
      Gujarat Registration
    </GSTREGISTRATION>
    <VOUCHERTYPENAME>Sales</VOUCHERTYPENAME>
    <PARTYLEDGERNAME>Flonix</PARTYLEDGERNAME>
    <VOUCHERNUMBER>30</VOUCHERNUMBER>
    <BASICBUYERNAME>Flonix</BASICBUYERNAME>
    <CMPGSTREGISTRATIONTYPE>Regular</CMPGSTREGISTRATIONTYPE>
    <PARTYMAILINGNAME>Flonix</PARTYMAILINGNAME>
    <CONSIGNEEMAILINGNAME>Flonix</CONSIGNEEMAILINGNAME>
    <CONSIGNEESTATENAME>Gujarat</CONSIGNEESTATENAME>
    <CMPGSTSTATE>Gujarat</CMPGSTSTATE>
    <CONSIGNEECOUNTRYNAME>India</CONSIGNEECOUNTRYNAME>
    <BASICBASEPARTYNAME>Flonix</BASICBASEPARTYNAME>
    <NUMBERINGSTYLE>Auto Retain</NUMBERINGSTYLE>
    <CSTFORMISSUETYPE>Not Applicable</CSTFORMISSUETYPE>
    <CSTFORMRECVTYPE>Not Applicable</CSTFORMRECVTYPE>
    <FBTPAYMENTTYPE>Default</FBTPAYMENTTYPE>
    ...
    <ALLINVENTORYENTRIES.LIST>
      ...
      <ACTUALQTY>5nos</ACTUALQTY>
      <BILLEDQTY>5nos</BILLEDQTY>
      <BATCHALLOCATIONS.LIST>
        <GODOWNNAME>Main Location</GODOWNNAME>
        <BATCHNAME>Primary Batch</BATCHNAME>
        <TRACKINGNUMBER>Not Applicable</TRACKINGNUMBER>
